  ...
  return (
    <div className="flex flex-wrap gap-4">
      <Card className="max-w-lg ">
        <h5 className="tracking-tight text-gray-900 dark:text-white">{Name}</h5>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          {Initiators.map((initiator) => (
            <div key={initiator} className="flex items-center space-x-4"></div>
          ))}
        </div>
      </Card>
      <Card className="grow max-w-lg h-fit">
